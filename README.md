...
Key Insights/ Result:
            Leading Indicator: Identified that "high-value segment" customers with an annual income exceeding $110k and an Education Level of 2 or higher (Graduate/Professional) are 3x more likely to accept a loan offer.
            Targeting Efficiency: By focusing marketing efforts on this specific segment, the bank can potentially reduce marketing spend by 60%* while maintaining 80%* of current conversion volume.
            Secondary Lead Indicator: Analysis showed that higher credit card spending (CCAvg) is a secondary lead indicator for loan requirement, allowing for better cross-selling opportunities.
----------------------------------------------------------------------------------------------------------------
